...
function Participantes() {
    ...
    async function salvarParticipante(participante) {
        try {
            ...
            if (participante.id) {
                await axios.put(`http://localhost:3006/eventos/${participante.id}`, participante);
                alert("Evento atualizado com sucesso!");
            } else {
                await axios.post("http://localhost:3006/eventos", participante);
                    ...
                    <tbody>
                        {participantes.map((participante) => (
                            <tr key={participante.id}>
                                ...
                                <td>{participante.localParticipante}</td>
